/*
 * Created by JFormDesigner on Thu Apr 13 00:23:32 IST 2017
 */
 ...
 * @author Vasu Agarwal
 */
public class Complex_Query5 extends JPanel {
    public Complex_Query5() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        //======== this2 ========
        {
            ...
            this2.add(label1);
            label1.setBounds(new Rectangle(new Point(95, 10), label1.getPreferredSize()));

            //---- button2 ----
            button2.setText("Logout");
            this2.add(button2);
            button2.setBounds(new Rectangle(new Point(255, 5), button2.getPreferredSize()));

            //---- button3 ----
            button3.setText("View");
            this2.add(button3);
            button3.setBounds(new Rectangle(new Point(135, 85), button3.getPreferredSize()));
            ...
            scrollPane1.setBounds(15, 130, 305, 155);

            //---- label2 ----
            label2.setText("Medication");
            this2.add(label2);
            label2.setBounds(new Rectangle(new Point(95, 65), label2.getPreferredSize()));
            this2.add(textField1);
            textField1.setBounds(165, 60, 70, textField1.getPreferredSize().height);

            //---- label3 ----
            label3.setText("Show illness of a patient who have taken a specific medication.");
            this2.add(label3);
            label3.setBounds(5, 40, 530, label3.getPreferredSize().height);
