/*
 * Created by JFormDesigner on Thu Apr 13 00:17:00 IST 2017
 */
 ...
 * @author Vasu Agarwal
 */
public class Complex_Query3 extends JPanel {
    public Complex_Query3() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        //======== this2 ========
        {
            ...
            this2.add(button2);
            button2.setBounds(new Rectangle(new Point(465, 5), button2.getPreferredSize()));
            ...
            //---- label2 ----
            label2.setText("Field of Specialization");
            this2.add(label2);
            ...
            //---- label3 ----
            label3.setText("Display details of a patient who has been given a prescription by a doctor specializing in a particular field.");
            this2.add(label3);
