/*
 * Created by JFormDesigner on Thu Apr 13 00:26:12 IST 2017
 */
 ...
 * @author Vasu Agarwal
 */
public class Complex_Query2 extends JPanel {
    public Complex_Query2() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        //======== this2 ========
        {
            ...
            this2.add(button2);
            button2.setBounds(new Rectangle(new Point(290, 5), button2.getPreferredSize()));
            ...
            scrollPane1.setBounds(15, 130, 345, 155);

            //---- label3 ----
            label3.setText("Finding Doctors who can consult 2 or more Patients.");
            this2.add(label3);
